...
class IdcSubject extends Component {
  constructor(props) {
    super(props);
    this.state = {
      isEditing: false,
  ...
  onFormChange = (values,key) => {
    console.log(values,key,'FormChange');
    /* 赋值至redux */
  ...
  render() {
    ...
    const itemFlag = updateForm[formListKey].item2 == undefined ? '' : updateForm[formListKey].item2[0];
    let autoList = Object.keys(autoComplete);
    console.log(666666666661111,autoComplete);
    console.log(66666666666,autoList);
    console.log(455)
    autoList.splice(autoList.indexOf('自定义'),1);
    return (
      <div className="g-quote-from-res">
        <Card formListIndex={formListIndex}
        ...
        >
          <Row>
            ...
            <Col {...col6}>
              <Item {...formItemLayout} label="机房地址"
                dataIndex={`[${formListKey}].roomAddress`}
            ...
            <Col {...col6}>
              <Item {...formItemLayout} label="二级计费项" dataIndex={`[${formListKey}].item2`}
                required
            ...
            <Col {...col6}>
              <Item {...formItemLayout} label="四级计费项" required trigger='onBlur'
            ...
            { checkEdit ?
              <>
                ...
                <Col {...col6}>
                  <Item
                    ...
                    rules={[{ required: false, message: ' ' },]}
                    decorator={
                      <Input maxLength={maxLength} placeholder="请输入机房" />
                    }
                  />
                </Col>
                <Col {...col6}>
              ...
              <>
                <Col  {...col6}>
                  <Item {...formItemLayout} label="机房名称"
          ...
          <Row>
            ...
            <Col {...col6}>
              <Item {...formItemLayout} label="用量计费模式"
                dataIndex={`[${formListKey}].usageUnit`}
                required
                rules={[{ required: true, message: ' ' },{ type: 'array', len: 1, message: '请选择单个' }]}
                decorator={
                  checkEdit ?
                    <Select allowClear mode='tags' optionFilterProp='children' placeholder="请下拉选择或输入" >
                      {
                        autoList.indexOf(itemFlag) !== -1?
          ...
          <Row>
            <Col {...col6}>
              <Item
                ...
                decorator={
                  checkEdit ?
                    <Select onFocus={() => this.getPriceUnit(formListKey)}
                      allowClear mode='tags' optionFilterProp='children'
                      placeholder="请选择"
                    >
                      { autoList.indexOf(itemFlag) !== -1 ?
...
export default connect(mapStateToProps, dispatchs('app', 'quoteResources'), null, { forwardRef: true })(IdcSubject)
