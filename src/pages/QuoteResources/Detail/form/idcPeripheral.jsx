...
class IdcPeripheral extends Component {
  constructor(props) {
    super(props);
    this.state = {
      isEditing: false,
  ...
  render() {
    ...
    const itemFlag = updateForm[formListKey].item2 == undefined ? '' : updateForm[formListKey].item2[0];
    const autoList = Object.keys(autoComplete);
    autoList.splice(autoList.indexOf('自定义'),1);
    return (
      <div className="g-quote-from-res">
        ...
        >
          <Row>
            ...
            <Col {...col6}>
              <Item {...formItemLayout} label="机房地址" required
                ...
                <Row key={1}>
                  <Col {...col6}>
                    <Item
                      ...
                      rules={[{ required: true, message: ' ' },]}
                      trigger='onBlur'
                      decorator={<Input maxLength={maxLength} placeholder="请输入" />
                      }
                    />
                  </Col>
                  <Col {...col6}>
                  ...
                  <Col {...col6}>
                    <Item
                      ...
                      //  optionFilterProp='children'  mode='tags'
                        <Select  mode='multiple' optionLabelProp="label" allowClear placeholder="请下拉选择或输入">
                ...
                <Row key={2}>
                  <Col {...col6}>
                    <Item
                      ...
                      label="四级计费项"
                      dataIndex={`[${formListKey}].item4`}
                      decorator={<span>{_.get(updateForm, `[${formListKey}].item4`, '')}</span>}
                    />
                  </Col>
                  <Col {...col6}>
                    <Item
...
export default connect(mapStateToProps, dispatchs('app', 'quoteResources'), null, { forwardRef: true })(IdcPeripheral)
