...
import { DynamicView, MarkdownParser } from '../index';
  ...
  return (
    <div>
      ...
      <DynamicView
        ...
        colProps={{span: 8}}
        items={[
          { title: '图标', dataIndex: 'icon', span: 24, render: src => <Avatar icon={<UserOutlined />} />},
      ...
      <DynamicView
        ...
        colProps={{span: 8}}
        items={[
          { title: '图标', dataIndex: 'icon', render: src => <Avatar icon={<UserOutlined />} />},
          { title: 'ID', dataIndex: 'id'},
          { title: '用户名', dataIndex: 'username'},
          { title: '名称', dataIndex: 'name'},
