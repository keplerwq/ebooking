...
import { Button, Row, Col, Modal, Input, Radio, Select, Checkbox } from 'antd';
            ...
            <Row gutter={8} key={index}>
              ...
              <Col span="2">
                <MinusCircleOutlined
                  ...
                  onClick={() => this.onArrayDel(props.bind, index)} />
              </Col>
            </Row>
          ))}
          <Button type="dashed" onClick={() => this.onArrayAdd(props.bind)}><PlusOutlined /> {props.addText}</Button>
        </div>
      )
    }
    // object 
          ...
          { listData.map((d, index) => (
            <Row gutter={8} key={index}>
              ...
              <Col span="2">
                <MinusCircleOutlined
                  className="dynamic-delete-button"
                  onClick={() => this.onArrayDel(dataIndex, index)} />
              </Col>
            </Row>
          ))}
          <Button type="dashed" onClick={() => this.onArrayAdd(dataIndex)}><PlusOutlined /> {props.addText}</Button>
        </div>
      )
    }
